...
if [ ! -r ccs-patch-1.8.9-20210401.tar.gz ]
then
    wget -O ccs-patch-1.8.9-20210401.tar.gz 'https://osdn.jp/frs/redir.php?f=/tomoyo/49684/ccs-patch-1.8.9-20210401.tar.gz' || die "Can't download patch."
fi
...
update_maintainer
tar -zxf ~/rpmbuild/SOURCES/ccs-patch-1.8.9-20210401.tar.gz || die "Can't extract patch."
