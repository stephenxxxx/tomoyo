...
if [ ! -r kernel-4.18.0-305.10.2.el8_4.src.rpm ]
then
    wget https://vault.centos.org/8.4.2105/BaseOS/Source/SPackages/kernel-4.18.0-305.10.2.el8_4.src.rpm || die "Can't download source package."
fi
LANG=C rpm --checksig kernel-4.18.0-305.10.2.el8_4.src.rpm | grep -F ': digests signatures OK' || die "Can't verify signature."
rpm -ivh kernel-4.18.0-305.10.2.el8_4.src.rpm || die "Can't install source package."
...
+%define buildid _tomoyo_1.8.9
 ...
 %define pkgrelease 305.10.2.el8_4
@@ -1097,6 +1097,10 @@
 
 # END OF PATCH APPLICATIONS
 
+# TOMOYO Linux
+tar -zxf %_sourcedir/ccs-patch-1.8.9-20210606.tar.gz
