...
then
    wget https://vault.centos.org/4.9/updates/SRPMS/kernel-2.6.9-103.EL.src.rpm || die "Can't download source package."
fi
LANG=C rpm --checksig kernel-2.6.9-103.EL.src.rpm | grep -F ': (sha1) dsa sha1 md5 gpg OK' || die "Can't verify signature."
...
@@ -26,7 +26,7 @@
 ...
 #
-%define release 103.EL
+%define release 103.EL_tomoyo_1.8.9
 %define sublevel 9
...
+patch -sp1 < patches/ccs-patch-2.6.9-centos-4.diff
+
