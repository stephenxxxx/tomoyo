...
LIVECD_HOME=~/LiveCD/
CD_LABEL="CentOS-5.11-i386-TOMOYO-LiveCD"
ISOIMAGE_NAME=../CentOS-5.11-i386-TOMOYO-LiveCD.iso
ORIGINAL_VERSION=2.6.18-238.el5
ORIGINAL_VERSION_REGEXP=2\.6\.18-238\.el5
KERNEL_VERSION=2.6.18-419.el5_tomoyo_1.8.6
...
mke2fs -j -m 0 -L "CentOS-5.11-i386-" -F squash/LiveOS/ext3fs.img || die "Can't create filesystem."
...
sed -i -e 's/5\.6-/5.11-/g' -e 's/quiet //g' -- isolinux/isolinux.cfg
