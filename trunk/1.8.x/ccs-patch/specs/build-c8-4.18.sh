...
if [ ! -r kernel-4.18.0-305.17.1.el8_4.src.rpm ]
then
    wget https://vault.centos.org/8.4.2105/BaseOS/Source/SPackages/kernel-4.18.0-305.17.1.el8_4.src.rpm || die "Can't download source package."
fi
LANG=C rpm --checksig kernel-4.18.0-305.17.1.el8_4.src.rpm | grep -F ': digests signatures OK' || die "Can't verify signature."
rpm -ivh kernel-4.18.0-305.17.1.el8_4.src.rpm || die "Can't install source package."
