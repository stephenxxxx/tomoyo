...
if [ ! -r kernel-4.18.0-305.3.1.el8.src.rpm ]
then
    wget https://vault.centos.org/8.4.2105/BaseOS/Source/SPackages/kernel-4.18.0-305.3.1.el8.src.rpm || die "Can't download source package."
fi
LANG=C rpm --checksig kernel-4.18.0-305.3.1.el8.src.rpm | grep -F ': digests signatures OK' || die "Can't verify signature."
rpm -ivh kernel-4.18.0-305.3.1.el8.src.rpm || die "Can't install source package."
...
+%define buildid _tomoyo_1.8.9
 ...
 %define pkgrelease 305.3.1.el8_4
@@ -1098,6 +1098,10 @@
